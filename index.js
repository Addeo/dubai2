    ...
    if (form) {
        ...
        formButton.addEventListener('click', function (e) {
            if (window.leadCM && window.leadCM.call && !callInit) {
                ...
                leadCM.dispatchCustomEvent("CUSTOM_PARAMS", custom_params, function() {window.leadCM.call(phone, 'universal_form');});
            }
        });
